...
// const inputRenderer = new Renderer(inputDiv, Renderer.Backends.SVG);
// // console.log(inputDiv.offsetWidth)

// var inputDisplayWidth = inputDiv.offsetWidth
// // Configure the rendering context.
// inputRenderer.resize(inputDisplayWidth, 400);
// const inputContext = inputRenderer.getContext();


// // Create a stave of width 400 at position 10, 40 on the canvas.
// const inputTrebleStave = new Stave(30, 80, inputDisplayWidth-100);
// const inputBassStave = new Stave(30, 200, inputDisplayWidth-100);
...
//     .setContext(inputContext)
//     .draw();
//     if(Object.keys(noteArray).length > 0){
//         var trebleNotes = [];
//         var trebleAccidentals = [];
//         var bassNotes = [];
//         var bassAccidentals = [];
...
// //   $('#London').on('mouseover',function(e){
// //     console.log(this);
// //   })
...
// tempo2.textContent = metronome.tempo;
